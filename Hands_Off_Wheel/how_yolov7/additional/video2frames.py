...
def extract_frames(video_path, output_folder, frame_rate=1):
    ...
    while True:
        ...
        if frame_count % frame_interval == 0:
            frame_filename = os.path.join(output_folder, f"ffsara_{saved_frame_count:04d}.jpg")
...
# Example usage
video_path = r"D:\GRAD_PROJECT\videos\rana.mp4" # Replace with your video file path
output_folder = r"C:\Users\Farah\Downloads\rana_output" # Replace with your desired output folder
