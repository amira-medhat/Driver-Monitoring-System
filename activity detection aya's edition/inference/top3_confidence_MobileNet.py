...
model_path = r"C:\Users\Amira\Driver-Monitoring-System\activity detection aya's edition\fine_tuned_mobilenetv3_with_aug.pth"
...
if __name__ == "__main__":
    ...
    # capture_process = threading.Thread(target=capture_frames, args=(frame_queue, stop_event, video_path))
    # process_process = threading.Thread(target=process_frames, args=(frame_queue, result_queue, stop_event))
