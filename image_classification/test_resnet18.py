...
if __name__ == "__main__":
    ...
    class CustomTestDataset(Dataset):
        ...
        def __getitem__(
            self, idx
        ):  # Loads an image at a specific index, applies transformations (e.g., resizing, normalization), and returns it.
    ...
    transform = transforms.Compose(
        ...
        """[
            ...
            transforms.CenterCrop(
                224
            ),  # Crop the center of the image of size (224, 224).
    ...
    torch.save(
        model.state_dict(), "fine_tuned_resnet18.pth"
    )  # The model's state is saved to a file (fine_tuned_resnet18.pth) after training.
